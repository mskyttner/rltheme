#' Import Georgia font for use in charts
#'
#' There is an option `rlheme.loadfonts` which -- if set to `TRUE` -- will
...
import_georgia <- function() {
  ...
  georgia_font_dir <- system.file("fonts", "georgia", package="rltheme")
