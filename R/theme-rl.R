#' A [ggplot2] theme with default for the Redpill-Linpro graphical profile.
#'
...
#'        caption="Brought to you for demo purposes") +
#'   theme_rl()
#'
#' # seminal bar chart
#'
...
#' }
theme_rl <- function(base_family="Lato", base_size = 11.5,
