...
#' @export
rl <- function(number_sections = FALSE,
                  fig_width = 7,
                  fig_height = 5,
  ...
  dep <- htmltools::htmlDependency(
    name = "rl",
    version = "0.1.0",
    system.file("rmarkdown", "templates", "rl", "resources", package = "rltheme"),
  ...
  args <- c(
    ...
    rmarkdown::pandoc_path_arg(
      system.file("rmarkdown", "templates", "rl", "base.html", package = "rltheme")
    )
  )
